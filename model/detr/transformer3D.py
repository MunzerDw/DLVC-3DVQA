...
Modified from https://github.com/zlccccc/3DVG-Transformer/blob/main/models/detr/transformer3D.py
...
from ..transformers.attention import MultiHeadAttention as MyMultiHeadAttention
