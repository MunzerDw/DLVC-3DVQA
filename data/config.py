...
CONF.PATH.MODELS = os.path.join(CONF.PATH.BASE, "model")
...
# scanqa data
CONF.PATH.SCANQA = os.path.join(CONF.PATH.DATA, "scanqa")
...
# output
CONF.PATH.OUTPUT = os.path.join(CONF.PATH.BASE, "logs")

# train
CONF.TRAIN = EasyDict()
CONF.TRAIN.MAX_TEXT_LEN = 36 #
CONF.TRAIN.MAX_ANSWER_LEN = 33 # 31 + 2 for start and end tokens
CONF.TRAIN.MAX_ANSWERS_LEN = 8 # max number of answers for a question is 8
CONF.TRAIN.SEED = 42